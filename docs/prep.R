...
# keep only the most recent sighting within each station-month, from full history
...
frames_data <- crossing(
  ...
  mutate(
    rri_unknown_previous = `Station Acronym` == 'RRI' &
      month_year %in% c('May 2025', 'Jun 2025', 'Jul 2025', 'Aug 2025', 'Sep 2025', 'Oct 2025', 'Nov 2025'),
